    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                <div>
                    <h4 class="mb-3">Lista de stock de productos</h4>
                    <p class="mb-0">Un panel de control de productos en stock le permite recopilar y visualizar fácilmente datos de productos en stock optimizando <br>
                        la experiencia del producto en stock, asegurando la retención del producto en stock.</p>
                </div>
            </div>
        </div>
                ...
                <div class="d-flex flex-wrap align-items-center justify-content-between">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="input-group col-sm-8">
                            <input type="text" id="search" class="form-control" name="search" placeholder="Buscatr producto" value="{{ request('search') }}">
